...
WebUI.callTestCase(findTestCase('Login/Login by parent success'), [('email') : 'luuhoanglong508@gmail.com', ('pass') : '12345'], 
    FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Menu/btnMenu'), 2)
...
WebUI.callTestCase(findTestCase('Registation/fill form registration - Ionic 6'), [('surname') : surname, ('othernames') : othernames
        , ('dob') : dob, ('img_player') : img_player, ('gender') : gender, ('hkid_type') : hkid_type, ('img_doc') : img_doc
        , ('club') : img_doc], FailureHandling.STOP_ON_FAILURE)
