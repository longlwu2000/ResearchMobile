...
Mobile.tap(findTestObject('Common/btnIsPresent by Text', [('text') : title]), 2)

titlebtn = new Date().format('MMMMM yyyy')

println(title)
Mobile.tap(findTestObject('Common/btnIsPresent by Text', [('text') : titlebtn]), 2)
