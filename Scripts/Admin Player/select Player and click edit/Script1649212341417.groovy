...
y = Mobile.getElementTopPosition(findTestObject('Common/btnIsPresent by Text', [('text') : 'Edit']), 3)

x = Mobile.getElementLeftPosition(findTestObject('Common/btnIsPresent by Text', [('text') : 'Edit']), 3)
