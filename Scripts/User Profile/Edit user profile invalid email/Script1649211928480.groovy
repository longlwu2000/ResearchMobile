...
Mobile.setText(findTestObject('Registation/inpInfomation', [('name') : 'Email']), 'admin@ezactive.com', 0)

Mobile.tap(findTestObject('User Profile/btnSave'), 0)

WebUI.callTestCase(findTestCase('Common/Verify Text Present'), [('text') : 'Please enter a valid email'], FailureHandling.STOP_ON_FAILURE)
